...
<!-- Mirrored from www.spruko.com/demo/adminor/html/Horizontal-Light/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Dec 2018 07:36:50 GMT -->
<head>
		<meta charset="UTF-8">
	...
	<body>
						...
						<div class="row authentication">
							<div class="col col-login mx-auto">
								<div class="text-center mb-6">
									<img src="<?= base_url('public') ?>/assets/images/brand/logo.png" class="h-8" alt="">
								</div>
								<form class="card" method="post">
									<div class="card-body p-6 ">
										<div class="card-title text-center">Vui lòng đăng nhập vào tài khoản</div>
										...
										<div class="input-icon form-group wrap-input">
											...
											<input type="password" name="login-password" class="form-control mb-0" id="exampleInputPassword1" placeholder="Password">
		...
		<script src="<?= base_url('public') ?>/assets/plugins/scroll-bar/jquery.mCustomScrollbar.concat.min.7f.delaye"></script>
